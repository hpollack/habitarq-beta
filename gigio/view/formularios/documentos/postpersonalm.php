			...
			<div class="col-md-9" id="cuerpo">
				<div class="row">
					<ol class="breadcrumb">
						...
						<li class="active">Ficha de Postulación Personal Mejoramiento</li>
					</ol>
				</div>
				<div class="row">
					<br>
					<div id="info"></div>
					<fieldset>
						<legend>Ficha de Postulación Personal Mejoramiento</legend>
						<form class="form-horizontal" id="fnuc">
							<div class="form-group">
								<label class="col-md-4 control-label" for="jruk">Código Rukam: </label>
								<div class="col-md-6">
									<input type="text" class="form-control" id="jruk" name="jruk" placeholder="Ingrese Código Rukam">
									<div id="sug"></div>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-4 control-label" for="jlmd">Llamado: </label>
								<div class="col-md-6">
									<select class="form-control" id="jlmd" name="jlmd" >
							...
							<div class="form-group">
								<label class="col-md-4 control-label" for="janio">Año: </label>
								<div class="col-md-6">
									<select class="form-control" id="janio" name="janio">
							...
							<div class="form-group">
								<div class="col-md-6 col-md-offset-4">
									<button type="button" class="btn btn-success" id="jbusc"><i class="fa fa-search"></i> Buscar</button>	
								</div>
								<div class="col-md-3">
									<div id="gbr"></div>
								</div>								
