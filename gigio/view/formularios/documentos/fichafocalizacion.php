			...
			<div class="col-md-9" id="cuerpo">
				<div class="row">
					<ol class="breadcrumb">
						...
						<li class="active">Nómina de Postulantes Focalización</li>
					</ol>
				</div>
				<div class="row">
					<div id="info"></div>					
					<h3 class="page-header">Nómina de Postulantes Focalizados.</h3>
					<form class="form-horizontal" action="<?php echo $url; ?>model/formularios/fichafocalizacion.php" method="post">
						<div class="form-group">
							<label class="col-md-4 control-label">Código Rukam: </label>
							<div class="col-md-6">
								<input class="form-control" type="text" id="ruk2" name="ruk2" placeholder="Ingrese Código Rukam">
								<div id="sug"></div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<select class="form-control" id="llmd1" name="llmd1" >
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								<button class="btn btn-success" type="button" id="fbusc"><i class="fa fa-search"></i> Buscar</button>
							</div>
							<div class="col-md-3">
								<div id="gbr"></div>
							</div>
						...
						<div id="bnom">
							...
							<div class="form-group">
								<label class="col-md-4 control-label" for="pnom">Nombre: </label>
								<div class="col-md-6">
									<p class="form-control-static" id="pnom"></p>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-4 control-label" for="ppos">N° Postulantes: </label>
								<div class="col-md-6">
									<p class="form-control-static" id="ppos"></p>
								</div>
							</div>							
						</div>
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								<button class="btn btn-primary" id="psub" type="submit" formtarget="_self" disabled><i class="fa fa-download"></i> Generar</button>
								<button class="btn btn-warning" id="prs" type="reset"><i class="fa fa-refresh"></i> Limpiar</button>
								<button  class="btn btn-danger" type="button" id="pcnl"><i class="fa fa-times"></i> Cancelar</button>
							</div>
						</div>
					</form>
				</div>
