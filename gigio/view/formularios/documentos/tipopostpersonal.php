			...
			<div class="col-md-9" id="cuerpo">
				<div class="row">
					<ol class="breadcrumb">
						...
						<li class="active">Ficha de Postulación Personal</li>
					</ol>
				</div>
				<div class="row">
					<h2 class="page-header">Tipo de Postulación</h2>
					<div class="col-md-4">
						<a href="<?php echo $url; ?>view/formularios/documentos/postpersonala.php" class="btn btn-warning btn-block"><i class="fa fa-plus fa-3x"></i><p>Ampliación</p></a>
					</div>
					<div class="col-md-4">
						<a href="<?php echo $url; ?>view/formularios/documentos/postpersonalm.php" class="btn btn-warning btn-block"><i class="fa fa-check fa-3x"></i><p>Mejoramiento</p></a>
					</div>	
				</div>
				<div class="row">
					<div id="plist"></div>
