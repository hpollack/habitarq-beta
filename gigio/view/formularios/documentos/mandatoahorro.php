			...
			<div class="col-md-9" id="cuerpo">
				<div class="row">
					<ol class="breadcrumb">
						...
						<li class="active">Mandato de Ahorro</li>
					</ol>
				</div>
				<div class="row">
					<br>
					...
					<fieldset>
						...
						<form class="form-horizontal" id="fnuc">
							<div class="form-group">
								<label class="col-md-4 control-label" for="mruk">Código Rukam: </label>
								<div class="col-md-6">
									<input type="text" class="form-control" id="mruk" name="mruk" placeholder="Ingrese Código Rukam">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-4 control-label" for="mlmd">Llamado: </label>
								<div class="col-md-6">
									<select class="form-control" id="mlmd" name="mlmd" >
							...
							<div class="form-group">
								<label class="col-md-4 control-label" for="manio">Año: </label>
								<div class="col-md-6">
									<select class="form-control" id="manio" name="manio">
							...
							<div class="form-group">
								<div class="col-md-6 col-md-offset-4">
									<button type="button" class="btn btn-success" id="mbusc"><i class="fa fa-search"></i> Buscar</button>	
								</div>
								<div class="col-md-3">
									<div id="gbr"></div>
								</div>								
