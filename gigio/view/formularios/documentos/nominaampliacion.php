		...
		<div class="row">
			...
			<div class="col-md-9" id="cuerpo">
				...
				<div class="row">
					...
					<form class="form-horizontal" action="<?php echo $url; ?>model/formularios/nominaampliacion.php" method="post">
						<div class="form-group">
							<label class="col-md-4 control-label">Código Rukam: </label>
							<div class="col-md-6">
								<input class="form-control" type="text" id="aruk" name="aruk" placeholder="Ingrese Código Rukam">
								<div id="sug"></div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<select class="form-control" id="allmd" name="allmd" >
						...
						<div class="form-group">
							<label class="col-md-4 control-label" for="aanio">Año: </label>
							<div class="col-md-6">
								<select class="form-control" id="aanio" name="aanio">
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								<button class="btn btn-success" type="button" id="aseek"><i class="fa fa-search"></i> Buscar</button>
							</div>
							<div class="col-md-3">
								<div id="gbr"></div>
							</div>
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								<button type="submit" id="asub" class="btn btn-primary" formtarget="_self" disabled><i class="fa fa-download"></i> Generar</button>
