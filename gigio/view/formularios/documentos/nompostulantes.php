			...
			<div class="col-md-9" id="cuerpo">
				<div class="row">
					<ol class="breadcrumb">
						...
						<li class="active">Nómina de Postulantes</li>
					</ol>
				</div>
				<div class="row">
					<div id="info"></div>					
					<h3 class="page-header">Nómina de Postulantes.</h3>
					<form class="form-horizontal" action="<?php echo $url; ?>model/formularios/nompostulantes.php" method="post">
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								<button class="btn btn-success" type="button" id="pseek"><i class="fa fa-search"></i> Buscar</button>
							</div>
							<div class="col-md-3">
								<div id="gbr"></div>
							</div>
