		...
		<div class="row">
			...
			<div class="col-md-9" id="cuerpo">
				<div class="row">
					...
					<div class="col-md-4">
						<a href="<?php echo $url; ?>view/formularios/individual.php" class="btn btn-warning btn-block"><i class="fa fa-user fa-3x"></i><p>Individual</p></a>
					</div>
					<div class="col-md-4">
						<a href="<?php echo $url; ?>view/formularios/grupal.php" class="btn btn-warning btn-block"><i class="fa fa-users fa-3x"></i><p>Colectivo</p></a>
					</div>					
				</div>
			</div>
		</div>
