			...
			<?php							
				if(mysqli_num_rows($sql2)>0){
					...
					while ($row = mysqli_fetch_array($sql2)) {
						...
						echo "<td>".$row[0]."</td>";
						echo "<td>".$row[1]."</td>";						
						echo "<td width='3%'><center><a href='".url()."model/formularios/mandatoahorro.php?r=".$r[0]."' class='btn btn-primary btn-sm' target='_self'><i class='fa fa-download'></i></a></center></td>";
						echo "</tr>";
					}					
